...
def format_snp_table(snp_data):
  f_snp_data = snp_data[['Sample', 'Position', 'Protein', 'AminoCorrect', 'NucleotideChange', 'AF', 'Syn', 'Depth', 'MatPeptide']].copy()
  f_snp_data.columns = [
    'SAMPLE_ID', 'GENOME_NT_POSITION', 'PROTEIN', 'AA_CHANGE', 'NT_CHANGE', 'ALLELE_FREQ', 'MUTATION_TYPE', 'DEPTH', 'MAT_PEPTIDE_INFO'
  ]
